def extra_args_provider(parser):
    ...
    group.add_argument(
        '--model-running-mode',
        type=str,
        default="difflm-noshift",
        choices=["difflm-noshift", "vanilla", "test-forward"],
    ...
    group.add_argument(
        ...
        choices=["causal_bottom_right", "no_mask", "block_causal", "causal"],
    ...
    # eval arguments
    group.add_argument(
        '--use-on-the-fly-eval', action='store_true', help='Whether to use on-the-fly eval.'
    )
    return parser
